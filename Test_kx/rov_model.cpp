...
ROV_Model::ROV_Model(double (* x)[2], QObject *parent) : QObject(parent)
{
    ...
    cw1[1] = 1; cw1[2] = 1.4; cw1[3] = 1.4;
    cw2[1] = 0.1; cw2[2] = 0.14; cw2[3] = 0.14;
    ...
    lambda[4][4] = 0; lambda[5][5] = 0.1; lambda[6][6] = 0.1;
...
void ROV_Model::resetModel(){
    ...
    for (int k=0; k<7;k++){
        Wv[k]=0;
        Vt[k]=0;
        h[k]=0;   //потом исправить на реальное значение сверху
    }
}
